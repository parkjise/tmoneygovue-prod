...
import { ref, watch, reactive, type PropType, nextTick, onMounted, onBeforeUnmount } from 'vue';
            ...
            >
              <template v-if="type == 'full' && !hideHeader && !hideCloseBtn">
                <button
                  ...
                  :aria-label="isBack ? '뒤로가기' : '팝업 닫기'"
                  @click="closeModal"
                  tabindex="1000"
                >
                  <uu-ic v-if="isBack" name="back" size="24"></uu-ic>
              ...
              <template v-else>
                ...
                <button type="button" class="modal_header_right_btn">
