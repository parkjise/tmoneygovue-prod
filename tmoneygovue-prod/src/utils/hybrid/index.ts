...
import type FlexPayment from './payment';
import type FlexTravel from './travel';
...
export default interface AppBridge extends FlexDevice, FlexEtc, FlexAuth, FlexPayment, FlexTravel {}
