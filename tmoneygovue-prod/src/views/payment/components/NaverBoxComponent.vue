<template>
  <div class="radio_box naverpay">
    ...
    <div class="mo_tmoney_con_txt mo_notice_area" v-if="paymentManagement.npayautPymInfo?.pblcPhrsTtlNm">
      <div v-for="(item, index) in paymentManagement.npayautPymInfo?.pblcPhrsTtlNm" :key="index">
        <div class="notice">
          <p class="badge">안내</p>
